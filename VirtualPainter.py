        ...
        if len(lmList) != 0:
            ...
            if fingers[1] and fingers[2]:
                ...
                if y1 > 120 and y1 < 210:
                    ...
                    elif 100 < x1 < 355 and drawColor == (255, 0, 255):
                        header = overlayList[0]
                        shape = 'freestyle'
                    elif 375 < x1 < 630 and drawColor == (255, 0, 255):
                        header = overlayList[6]
                        shape = 'circle'
                    elif 645 < x1 < 930 and drawColor == (255, 0, 255):
                        header = overlayList[7]
                        shape = 'rectangle'
                    elif 945 < x1 < 1200 and drawColor == (255, 0, 255):
                        header = overlayList[8]
                        shape = 'elipse'
                    elif 100 < x1 < 355 and drawColor == (255, 0, 0):
                        header = overlayList[10]
                        shape = 'freestyle'
                    elif 375 < x1 < 630 and drawColor == (255, 0, 0):
                        header = overlayList[11]
                        shape = 'circle'
                    elif 645 < x1 < 930 and drawColor == (255, 0, 0):
                        header = overlayList[12]
                        shape = 'rectangle'
                    elif 945 < x1 < 1200 and drawColor == (255, 0, 0):
                        header = overlayList[13]
                        shape = 'elipse'
                    if 100 < x1 < 355 and drawColor == (0, 255, 0):
                        header = overlayList[1]
                        shape = 'freestyle'
                    elif 375 < x1 < 630 and drawColor == (0, 255, 0):
                        header = overlayList[2]
                        shape = 'circle'
                    elif 645 < x1 < 930 and drawColor == (0, 255, 0):
                        header = overlayList[3]
                        shape = 'rectangle'
                    elif 945 < x1 < 1200 and drawColor == (0, 255, 0):
            ...
            if fingers[1] and fingers[2] == False:
                ...
                if drawColor == (0, 0, 0):
                    ...
                    if shape == 'elipse':
                        ...
                        if fingers[4]:
                            cv2.ellipse(imgCanvas, (x1, y1), (a, b), 0, 0, 360, drawColor, 1)
